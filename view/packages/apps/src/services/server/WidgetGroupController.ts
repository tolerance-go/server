...
export async function WidgetGroupControllerFindAll(
  ...
  return request<API.WidgetGroupListResponse>('/api/widgetGroups/findAll', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function WidgetGroupControllerFindAndCountAll(
  ...
  return request<API.WidgetGroupListAndCountResponse>('/api/widgetGroups/findAndCountAll', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
