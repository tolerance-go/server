...
export async function WidgetLibControllerIndex(
  ...
  params: Server.WidgetLibControllerIndexParams,
  options?: { [key: string]: any },
) {
  return request<Server.WidgetLibListRsp>('/api/widgetLibs', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function WidgetLibControllerCreate(
  body: Server.WidgetLibCreateReqData,
  options?: { [key: string]: any },
) {
  return request<Server.WidgetLibRsp>('/api/widgetLibs', {
    method: 'POST',
    headers: {
...
export async function WidgetLibControllerShow(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: Server.WidgetLibControllerShowParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<Server.WidgetLibRsp>(`/api/widgetLibs/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function WidgetLibControllerUpdate(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: Server.WidgetLibControllerUpdateParams,
  body: Server.WidgetLibUpdateReqData,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<Server.WidgetLibRsp>(`/api/widgetLibs/${param0}`, {
...
export async function WidgetLibControllerDestroy(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: Server.WidgetLibControllerDestroyParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<Server.WidgetLibRsp>(`/api/widgetLibs/${param0}`, {
...
export async function WidgetLibControllerBulkDestroy(
  ...
  return request<Server.CountResponse>('/api/widgetLibs/bulkDestroy', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function WidgetLibControllerFindAll(
  ...
  return request<Server.WidgetLibListRsp>('/api/widgetLibs/findAll', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function WidgetLibControllerFindAndCountAll(
  ...
  return request<Server.WidgetLibListAndCountRsp>('/api/widgetLibs/findAndCountAll', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
